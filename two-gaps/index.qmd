...
subtitle: "“If we know what's healthy, why don't we eat it?” is one of the most common questions in nutrition. It hides two assumptions, and our work breaks both: we don't actually share a definition of healthy, and where eating collapses, the reason isn't the one everyone reaches for."
author:
  - "Josh Erndt-Marino, PhD"
  - "FRESH's AI assistant"
date: "2026-06-28"
description: |
  "If we know what's healthy, why don't we eat it?" assumes we know, and that the
  gap is willpower. Two FRESH findings break both halves: experts disagree and
  the public misperceives, so the knowing is shaky; and where eating clearly
  collapses (a fruit cliff from 61% to 6%), the driver is not price. Two gaps,
  both in environments we under-measure.
...
Bring in the public and a second layer opens. Set roughly 450 consumers' beliefs
against the pooled expert rating and more than eight in ten foods miss by a full
grade. The miss also has a direction: most foods pull both ways at once, but the
...
The reflex is to call it cost. The reflex is wrong here. The income gap runs
...
clearly. The second sits in the environment that surrounds the eater and the
concern and knowledge they carry into it. Both are features of the
**informational and food environments**, the parts of the system we measure
least and fund last.

What we reach for instead are the two loudest dials: willpower and price. Tell
...
The honest version of the talk's question is not “why don't we eat it.” It is two
questions. Do we actually agree on what healthy is, and have we said it clearly?
And does the world around the eater make the healthy choice the available one?
Answer those and the willpower question mostly takes care of itself.

> **The gap between knowing and eating is really two gaps, and neither one is willpower.**

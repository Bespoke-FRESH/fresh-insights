...
subtitle: "U.S. fruit adherence collapses with age, not income — and the number everyone reports hides both. And none of the numbers do justice to the complexities of age as a social and biological variable."
author:
  - "Josh Erndt-Marino, PhD"
  - "FRESH's AI assistant"
date: "2026-06-18"
description: |
  Within U.S. children, fruit-guideline adherence drops from roughly 60% among
  the youngest to 6% by the teen years — a collapse the single national figure
  averages away. The gap tracks age far more than income or price.
categories: [nutrition, measurement, surveys, equity, FRESH]
fresh-engines: [Usual-Intake]
topics: [Equity, Surveys]
card-subtitle: "U.S. fruit adherence collapses with age, not income, and the single national number hides both."
---

::: {.fi-tldr}
**The short version.** *Claims here link to where they are worked out in full.*

USDA reports that about 23% of American children meet the fruit recommendation.
That single number hides the entire finding.

- **The average is a lid on a cliff.** Within US children, adherence runs from
  **61% among toddlers to 6% by the late teens** — a 55-point collapse the
  national figure averages away.
- **Cost is real and second-order.** There is an income gradient — lower-income
  kids at 18%, higher-income at 25% — but it is **7 points against age's 55**.
  About twelve cents on the dollar of the age gradient.
- **Income is not even the through-line.** The highest-adherence children in the
  country are Mexican-American at **31%**, ahead of higher-income non-Hispanic
  White children at 18%. One variable cannot move both directions.
- **We reproduced the number three ways** before arguing with it — the NCI
  two-part method (13.8% overall), a multilevel small-area model (14.6%), and a
  small-area model of per-day compliance (12.1%). The estimator is not the
  problem. The resolution is.

**And "age" is not an answer either.** A 55-point collapse across childhood is a
social transition wearing a biological variable's clothing — the question is
what changes around the eater, not what changes inside them.

**The point.** Design the estimate for the decision, not the press release. A
number reported at national resolution cannot tell you where to act.
:::
...
That ERS number is where I started. Building on our previous work[^oj], before I'd trust our own pipeline to say anything ERS didn't, I wanted it to agree where ERS already had an answer. So I estimated the same quantity on NHANES three ways: the NCI two-part method (13.8% overall), a multilevel small-area model — the kind political scientists use to estimate opinion in all 50 states from one national poll (14.6%) — and a small-area model of per-day compliance (12.1%).
...
That a single cost variable can't carry the gap is exactly what USDA's own report finds from the other side. In their model, household income and fruit prices have *less* influence on whether someone meets the recommendation than behaviors that signal concern for health and nutrition knowledge.[^ersdrivers]

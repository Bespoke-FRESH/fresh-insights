...
I have run exactly this analysis across the US carb-rich food supply, and the "uncertain" zone is not small. Of roughly 3,200 carb-rich foods, about 20% are in it. For grains specifically, the number is ~50%. Half of all grain-based foods are foods on which the experts cannot agree.

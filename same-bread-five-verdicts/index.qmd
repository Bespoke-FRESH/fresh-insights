...
description: |
  ...
  It is a portrait of how nutrition decides what counts as "healthy" --- and why the
...
I have run this analysis across the US carb-rich food supply. Of roughly 3,200 carb-rich foods, about 20% are in the "uncertain" zone. For grains specifically, the number is ~50%. Half of all grain-based foods are foods on which the experts cannot agree.
